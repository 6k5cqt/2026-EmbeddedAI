...
# ── 파라미터 ───────────────────────────────────
ROI_TOP_RATIO    = 0.2   # 마스크 bbox 상단에서 탐색 시작 비율
ROI_BOTTOM_RATIO = 0.8   # 마스크 bbox 상단에서 탐색 끝 비율
TARGET_Y_RATIO   = 0.5   # 마스크 bbox 내 목표점 비율
MIN_SEG_WIDTH    = 20
MIN_MASK_RATIO   = 0.3
# ───────────────────────────────────────────────
...
def draw_centerline(frame, mask):
    ...
    poly   = np.poly1d(np.polyfit(ys_arr, xs_arr, 1))
